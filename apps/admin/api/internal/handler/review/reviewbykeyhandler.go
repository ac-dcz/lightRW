...
func ReviewByKeyHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ReviewByKeyReq
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := review.NewReviewByKeyLogic(r.Context(), svcCtx)
		resp, err := l.ReviewByKey(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
